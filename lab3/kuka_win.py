...
def leaveTrace(cubes):
    ...
    for cube in cubes:
        ...
        for trace in traceCubes:
            ...
            if np.linalg.norm(
                    [pos[0] - tracePos[0], pos[1] - tracePos[1]]) <= TRACE_MIN_DIST:
                hasNeighbour = True
...
cubes = [loadCube([0.1, W_Y_MAX, 0.05])]
